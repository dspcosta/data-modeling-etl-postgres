...
songplay_table_create = ("""
    CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, \
        start_time timestamp NOT NULL, user_id int NOT NULL REFERENCES users(user_id), \
...
song_select = ("""
    ...
    WHERE CONCAT(s.title,'_', a.name,'_', s.duration) = \
        CONCAT(%s,'_',%s,'_',%s);
""")
...
create_table_queries = [
    ...
    song_table_create, songplay_table_create, time_table_create]
